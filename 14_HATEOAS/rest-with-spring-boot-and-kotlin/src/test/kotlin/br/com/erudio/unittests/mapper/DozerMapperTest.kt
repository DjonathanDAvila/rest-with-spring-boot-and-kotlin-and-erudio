...
class DozerMapperTest {
    ...
    fun parseEntityToVOTest() {
        ...
        assertEquals(0, output.idPerson)
    ...
    fun parseEntityListToVOListTest() {
        ...
        assertEquals(0, outputZero.idPerson)
        ...
        assertEquals(7.toLong(), outputSeven.idPerson)
        ...
        assertEquals(12.toLong(), outputTwelve.idPerson)
